...
///
/// For sync lyrics, this contains the timestamp and the normalised relative gap to the previous line
/// of lyrics. A `gap_to_prev == 0.5` would mean this gap is about 50% that of the longest gap in
/// all the lyrics.
#[allow(unused)]
#[derive(Debug, Clone)]
...
impl LyricsLine {
  #[must_use]
  pub fn from_lyrics(lyrics: &str) -> (Vec<Self>, Option<BTreeSet<LrcTag>>) {
